...
describe('createBattle()', () => {
  ...
  const makeGetExampleStateWithFriendsAndFoes = (
    battle: types.Battle = inputBattle
  ) => (): ExpeditionsStateSlice &
    NemesisContentStateSlice &
    UpgradedBasicNemesisCardContentStateSlice &
        ...
        expeditions: {
          expedition1: {
            ...
            settingsSnapshot: {
              ...
              availableFriendIds: ['UnitTheTestCase'],
              availableFoeIds: ['TheAssertionFailure']
            },
            friendsAndFoesConfig: { playerCountForBanners: 1},
            seed: inputSeed,
            sequence: {
              firstBranchId: battle.id,
              branches: {
      ...
      Expansions: {
        ...
        Foes: {
          content: {
            ENG: {
              TheAssertionFailure: {
                name: "The Assertion Failure",
                id: 'The Assertion Failure',
                charges: 3,
              }
            }
          }
  ...
  it('should pick friend and foe when enabled', () => {
    const result = createBattle(
      makeGetExampleStateWithFriendsAndFoes(),
      inputBattle as types.Battle
    )
    ...
    expect(result).toEqual({
      battle: {
        ...
        friendId: 'UnitTheTestCase',
        foeId: 'TheAssertionFailure',
        status: 'before_battle',
        tries: 0,
      },
      upgradedBasicNemesisCardIds: ['Wreck', 'BaneCommander'],
