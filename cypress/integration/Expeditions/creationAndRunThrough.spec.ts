describe('Expedition creation and run through', () => {
  ...
  it('can run through the first battle', () => {
    cy.get('h2').contains('Test-Expedition 1').click()
  ...
  it('can run through the second battle', () => {
    ...
    cy.get('[data-test="btn-start-battle"]').click()
    cy.get('[data-test="btn-battle-won"]').click()
    cy.get('p').contains('Drown in Flames').click()
    cy.get('p').contains('Mages Totem').click()
    cy.get('p').contains('Unrefined Blaststone').click()
    cy.get('[data-test="btn-unlock-next-battle"]').click()
  })
  ...
  it('can run through the third battle', () => {
    ...
    cy.get('[data-test="btn-start-battle"]').click()
    cy.get('[data-test="btn-battle-won"]').click()
    cy.get('p').contains('Triplite Core').click()
    cy.get('p').contains('Polyphase Turbine').click()
    cy.get('p').contains('Planar Insight').click()
    cy.get('[data-test="btn-unlock-next-battle"]').click()
  })
  ...
  it('has correct final barracks', () => {
    ...
    cy.get('p').contains('Burning Opal').should('be.visible')
    cy.get('p').contains('Bloodstone Jewel').should('be.visible')
    cy.get('p').contains('Geophage').should('be.visible')
    cy.get('p').contains('Vim Dynamo').should('be.visible')
    cy.get('p').contains('Fire Chakram').should('be.visible')
    cy.get('p').contains('Force Amplifier').should('be.visible')
    cy.get('p').contains('Convection Field').should('be.visible')
    cy.get('p').contains('Radiance').should('be.visible')

    // Treasures
    cy.get('[data-test="treasure"]').click({ force: true })
    cy.get('p').contains("Xaxo's Pyre").should('be.visible')
    cy.get('p').contains("Mist's Amethyst Paragon").should('be.visible')
    cy.get('p').contains("Gex's Shattered Geode").should('be.visible')
    cy.get('p').contains("Remnant's Void Shard").should('be.visible')
    cy.get('p').contains("Yan Magda's Illuminate").should('be.visible')
    cy.get('p').contains("Glutton's Tooth").should('be.visible')
    cy.get('p').contains('Edible Fungus Chunks').should('be.visible')
    cy.get('p').contains("Wraith's Essence").should('be.visible')
    cy.get('p')
      .contains('Entwined Aether Strands')
      .scrollIntoView()
      .should('be.visible')
    cy.get('p').contains('Purified Bangle').should('be.visible')
    cy.get('p').contains('Fanged Choker').should('be.visible')
    cy.get('p').contains('Flowing Mantle').should('be.visible')
    cy.get('p').contains('Precision Magnifier').should('be.visible')
    ...
    cy.get('p').contains('Sacrifice').should('be.visible')
    cy.get('p').contains('Thunderous Tempest').should('be.visible')
    cy.get('p').contains('Furrow Of Destruction').should('be.visible')
    cy.get('p').contains('Marked').scrollIntoView().should('be.visible')
    cy.get('p').contains('Ray Of Desolation').should('be.visible')
    cy.get('p').contains('Terrify').should('be.visible')
    ...
    cy.get('p').contains('Breach Ore').should('be.visible')
    cy.get('p').contains('Riddle Sphere').should('be.visible')
    cy.get('p').contains('Mentite Chunk').should('be.visible')
    cy.get('p').contains('Nerve Jab').scrollIntoView().should('be.visible')
    cy.get('p').contains('Unrefined Blaststone').should('be.visible')
    cy.get('p').contains('Mages Totem').should('be.visible')
    cy.get('p')
      .contains('Drown in Flames')
      .scrollIntoView()
      .should('be.visible')
    cy.get('p').contains('Triplite Core').should('be.visible')
    cy.get('p').contains('Polyphase Turbine').should('be.visible')
    cy.get('p').contains('Planar Insight').should('be.visible')
  })
